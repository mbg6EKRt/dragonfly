...
function CInfo(cont, cls, msg, img, skinName, noErrorText)
{
	...
	this._errorWithoutDescText = noErrorText;
}
...
CInfo.prototype = {
	...
	SetInfo: function (text)
	{
		if (this._isError)
		{
			this.Class('wm_error_information', '', 'error.gif');
		}
		else
		{
			this.Class('wm_information', 'wm_hide', 'error.gif');
		}
		this._message.innerHTML = (text) ? text : this._errorWithoutDescText;
	},
