...
<table class="wm_admin_center" width="500" border="0">
	...
	<tr>
		...
		<td colspan="2">
			<input type="text" name="txtSiteName" onchange="change();" value="<?php echo dequote($settings->WindowTitle);?>" size="50" class="wm_input" maxlength="100">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" class="wm_input" name="txtIncomingMail"  id="txtIncomingMail" onchange="change();" value="<?php echo dequote($settings->IncomingMailServer);?>" maxlength="100">
		</td>
		<td>
			Port:&nbsp;<input type="text" class="wm_input" name="intIncomingMailPort" id="intIncomingMailPort" size="3" onchange="change();" value="<?php echo dequote($settings->IncomingMailPort);?>" maxlength="5">
		</td>
	</tr>
	<tr>
		<td align="right">Outgoing Mail: </td>
		<td>
			<input type="text" class="wm_input" name="txtOutgoingMail" onchange="change();" value="<?php echo dequote($settings->OutgoingMailServer);?>" maxlength="100">
		</td>
		<td>
			Port:&nbsp;<input type="text" class="wm_input" name="intOutgoingMailPort" onchange="change();" size="3" value="<?php echo dequote($settings->OutgoingMailPort);?>" maxlength="5">
		</td>
	</tr>
	<tr>
		<td align="right">&nbsp;</td>
	...
	<tr>
		...
		<td colspan="2">
			<input type="text" class="wm_input" name="intAttachmentSizeLimit" id="intAttachmentSizeLimit" onchange="change();" style="width: 85px" value="<?php echo dequote($settings->AttachmentSizeLimit);?>" maxlength="100" maxlength="10"> bytes
			&nbsp;&nbsp;&nbsp;
