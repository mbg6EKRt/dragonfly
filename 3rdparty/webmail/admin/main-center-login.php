...
requirements.
	...
	<tr>
		...
		<td><br />
			...
			<br /><br />&nbsp;<input type="text" name="txtUseDomain" onchange="change();" value="<?php echo dequote($settings->DefaultDomainOptional);?>" id="txtUseDomain" class="wm_input" size="20" />&nbsp;&nbsp;domain to use
			<br /><br />
			...
			<label for="intLoginAsConcatination">Email as concatenation of "Login" field + "@" + domain</label>
		</td>
	</tr>
	<tr>
		<td align="right" valign="top">
