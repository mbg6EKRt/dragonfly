...
<html>
	<head>
		...
		<script>
var mtext = "<?php echo ConvertUtils::ClearJavaScriptString($fullBodyText, '"'); ?>";

function Init() {
	var mbody = document.getElementById("maindiv");
	if (mbody)
	{
		mbody.innerHTML = mtext;
	}
}
		</script>
	</head>
	<body class="wm_body" onload="Init()">
			...
			<table class="wm_print">
				...
				<tr>
					<td colspan="2" class="wm_print_content" style="border-width: 1px 0px 0px 0px">
						<div class="wm_space_before" id="maindiv"></div>
					</td>
				</tr>
			</table>
		</div>
