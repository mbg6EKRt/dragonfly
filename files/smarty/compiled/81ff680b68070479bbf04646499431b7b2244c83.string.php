<?php /* Smarty version Smarty 3.1.4, created on 2014-04-19 22:56:25
         compiled from "81ff680b68070479bbf04646499431b7b2244c83" */ ?>
<?php /*%%SmartyHeaderCode:7104871205352e2f9bd5218-73300320%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81ff680b68070479bbf04646499431b7b2244c83' => 
    array (
      0 => '81ff680b68070479bbf04646499431b7b2244c83',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '7104871205352e2f9bd5218-73300320',
  'function' => 
  array (
    'showentities' => 
    array (
  ...
  'unifunc' => 'content_5352e2f9ddf3a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5352e2f9ddf3a')) {function content_5352e2f9ddf3a($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['first'] = new Smarty_variable('yes', null, 0);?>
...
</strong><?php echo $_smarty_tpl->tpl_vars['entities']->value['children']['entities'][$_smarty_tpl->tpl_vars['relationship']->value['id2']]['name'];?>

				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['relationship']->value['id2']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
					<br /><strong><?php echo $_smarty_tpl->tpl_vars['relationship']->value['name'];?>
</strong><?php echo $_smarty_tpl->tpl_vars['entities']->value['children']['entities'][$_smarty_tpl->tpl_vars['relationship']->value['id1']]['name'];?>
