<?php /* Smarty version Smarty 3.1.4, created on 2014-05-24 17:33:52
         compiled from "d1c88de24e45d6d7d8610f0b5dc572a9cf340d94" */ ?>
<?php /*%%SmartyHeaderCode:18550422735380bbe0b6efa0-28922459%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1c88de24e45d6d7d8610f0b5dc572a9cf340d94' => 
    array (
      0 => 'd1c88de24e45d6d7d8610f0b5dc572a9cf340d94',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '18550422735380bbe0b6efa0-28922459',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5380bbe0cc008',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5380bbe0cc008')) {function content_5380bbe0cc008($_smarty_tpl) {?><h1><?php echo $_smarty_tpl->tpl_vars['formTitle']->value;?>
</h1>
<!--
...
">
-->
<form id="addeditentity" class="_100 clear" enctype="multipart/form-data" method="POST">
	...
	<div class="clear">
		...
		<div id="details" class="tab clear">
...
" onkeyup="javascript:setURL();" onchange="javascript:setURL();" /></span>
		...
		<div id="relationships" class="hidden tab clear">
			<h2>Relationships</h2>
			<div class="clear">
				Add Relationship:
...
<br /><?php echo $_smarty_tpl->tpl_vars['relationship']->value['description'];?>
		...
		<div id="save" class="hidden tab clear">
...
function save_relationship()
{
	...
	$( "#relrows" ).html( "<div>" + name + "<br />" + description + "</div>&nbsp;" + $( "#relrows" ).html( ) );
