<?php /* Smarty version Smarty 3.1.4, created on 2013-09-08 20:05:11
         compiled from "7bf91613bf1785c196a5567cf646d125eeb605c8" */ ?>
<?php /*%%SmartyHeaderCode:27856522cd8773a5181-99803732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7bf91613bf1785c196a5567cf646d125eeb605c8' => 
    array (
      0 => '7bf91613bf1785c196a5567cf646d125eeb605c8',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '27856522cd8773a5181-99803732',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cd87806a47',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cd87806a47')) {function content_522cd87806a47($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['first'] = new Smarty_variable('yes', null, 0);?>
...
$_smarty_tpl->tpl_vars['entity']->_loop = true;
 $_smarty_tpl->tpl_vars['id']->value = $_smarty_tpl->tpl_vars['entity']->key;
?>
	$('#entity_relationships_'+<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
).offset({
		left:((width/2) - ($('#entity_relationships_'+<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
).width()/2)),
		top:((height/2) - ($('#entity_relationships_'+<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
).height()/2))
	});
	<?php } ?>
