<?php /* Smarty version Smarty 3.1.4, created on 2014-09-24 21:22:47
         compiled from "8cebaf84735134e706360b8f4c9356138a968642" */ ?>
<?php /*%%SmartyHeaderCode:2465554231a07bcbeb7-37482738%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cebaf84735134e706360b8f4c9356138a968642' => 
    array (
      0 => '8cebaf84735134e706360b8f4c9356138a968642',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '2465554231a07bcbeb7-37482738',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54231a080571e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54231a080571e')) {function content_54231a080571e($_smarty_tpl) {?><h1><?php echo $_smarty_tpl->tpl_vars['formTitle']->value;?>
</h1>
<!--
...
<form id="addeditsite" class="_100" enctype="multipart/form-data" method="POST">
	...
	<div>
		...
		<div id="details" class="tab white_25">
		<table class="_100">
...
"<?php if ($_smarty_tpl->tpl_vars['default_layout']->value==$_smarty_tpl->tpl_vars['layout']->value['id']){?> selected="selected"<?php }?>>&nbsp;&nbsp;- <?php echo $_smarty_tpl->tpl_vars['layout']->value['name'];?>
		...
		<div id="seo" class="hidden tab  white_25">
...
" /></span>
		...
		<div id="modules" class="hidden tab white_25">
...
"<?php if ($_smarty_tpl->tpl_vars['module']->value['selected']==1){?> checked="checked"<?php }?> />&nbsp;<?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
		...
		<div id="security" class="hidden tab white_25">
			<?php echo $_smarty_tpl->tpl_vars['permissionsform']->value;?>

		</div>

		<div id="save" class="hidden tab white_25">
