<?php /* Smarty version Smarty 3.1.4, created on 2014-05-10 16:55:32
         compiled from "b0871e06558b9a693b09e3d0b624923f7267edf4" */ ?>
<?php /*%%SmartyHeaderCode:1750384373536e3de4a220a0-38187950%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0871e06558b9a693b09e3d0b624923f7267edf4' => 
    array (
      0 => 'b0871e06558b9a693b09e3d0b624923f7267edf4',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '1750384373536e3de4a220a0-38187950',
  'function' => 
  array (
    'getentityname' => 
    array (
  ...
  'unifunc' => 'content_536e3de4cb4f4',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_536e3de4cb4f4')) {function content_536e3de4cb4f4($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_getentityname')) {
...
?>
            <?php if ($_smarty_tpl->tpl_vars['getid']->value==$_smarty_tpl->tpl_vars['parententity']->value['id']){?>
                <h3><?php echo $_smarty_tpl->tpl_vars['parententity']->value['name'];?>
</h3>
            <?php }?>
        <?php } ?>
    <?php }?>
...
?>
            <?php if ($_smarty_tpl->tpl_vars['getid']->value==$_smarty_tpl->tpl_vars['childentity']->value['id']){?>
                <h3><?php echo $_smarty_tpl->tpl_vars['childentity']->value['name'];?>
</h3>
            <?php }?>
        <?php } ?>
