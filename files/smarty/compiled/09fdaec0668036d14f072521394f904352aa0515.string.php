<?php /* Smarty version Smarty 3.1.4, created on 2013-09-08 18:05:42
         compiled from "09fdaec0668036d14f072521394f904352aa0515" */ ?>
<?php /*%%SmartyHeaderCode:23163522cbc76d8e7b2-53145675%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09fdaec0668036d14f072521394f904352aa0515' => 
    array (
      0 => '09fdaec0668036d14f072521394f904352aa0515',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '23163522cbc76d8e7b2-53145675',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cbc776f8c7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cbc776f8c7')) {function content_522cbc776f8c7($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['entity'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['entity']->_loop = false;
...
function position()
{
	...
	$('.entity').offset(
	{
		left:((width/2) - ($('.entity').width()/2)),top:((height/2) - ($('.entity').height()/2)
	});
}
