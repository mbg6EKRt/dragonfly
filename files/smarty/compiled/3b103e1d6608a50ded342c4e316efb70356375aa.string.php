<?php /* Smarty version Smarty 3.1.4, created on 2014-05-10 17:24:21
         compiled from "3b103e1d6608a50ded342c4e316efb70356375aa" */ ?>
<?php /*%%SmartyHeaderCode:57656461536e44a52f2965-83846333%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b103e1d6608a50ded342c4e316efb70356375aa' => 
    array (
      0 => '3b103e1d6608a50ded342c4e316efb70356375aa',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '57656461536e44a52f2965-83846333',
  'function' => 
  array (
    'getentityname' => 
    array (
  ...
  'unifunc' => 'content_536e44a558af4',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_536e44a558af4')) {function content_536e44a558af4($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_getentityname')) {
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['entities']->value['entities'])){?>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['relationship']->value['id1']==$_smarty_tpl->tpl_vars['entity']->value['id']||$_smarty_tpl->tpl_vars['relationship']->value['id2']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['relationship']->value['id1']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
                        <?php if (isset($_smarty_tpl->tpl_vars['entities']->value['children'])){?>
                            <?php smarty_template_function_getentityname($_smarty_tpl,array('getid'=>$_smarty_tpl->tpl_vars['relationship']->value['id2'],'entities'=>$_smarty_tpl->tpl_vars['entities']->value));?>

                        <?php }?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['relationship']->value['id2']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
                        <?php if (isset($_smarty_tpl->tpl_vars['entities']->value['children'])){?>
                            <?php smarty_template_function_getentityname($_smarty_tpl,array('getid'=>$_smarty_tpl->tpl_vars['relationship']->value['id1'],'entities'=>$_smarty_tpl->tpl_vars['entities']->value));?>
