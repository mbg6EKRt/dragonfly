<?php /* Smarty version Smarty 3.1.4, created on 2014-05-10 17:17:22
         compiled from "e7d968837c63834e5082f5fcd3b600d10e00a3f3" */ ?>
<?php /*%%SmartyHeaderCode:1197660205536e4302df08b0-56570875%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7d968837c63834e5082f5fcd3b600d10e00a3f3' => 
    array (
      0 => 'e7d968837c63834e5082f5fcd3b600d10e00a3f3',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '1197660205536e4302df08b0-56570875',
  'function' => 
  array (
    'getentityname' => 
    array (
  ...
  'unifunc' => 'content_536e430318990',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_536e430318990')) {function content_536e430318990($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_getentityname')) {
 ...
 $_from = $_smarty_tpl->tpl_vars['parents']->value['entities']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
 ...
 $_smarty_tpl->tpl_vars['id'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['children']->value['entities']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
                ...
                <?php if ($_smarty_tpl->tpl_vars['relationship']->value['id1']==$_smarty_tpl->tpl_vars['entity']->value['id']||$_smarty_tpl->tpl_vars['relationship']->value['id2']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['relationship']->value['id1']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
                        <?php if (isset($_smarty_tpl->tpl_vars['entities']->value['children'])){?>
                            <?php smarty_template_function_getentityname($_smarty_tpl,array('getid'=>$_smarty_tpl->tpl_vars['relationship']->value['id2'],'parents'=>$_smarty_tpl->tpl_vars['entities']->value,'children'=>$_smarty_tpl->tpl_vars['entities']->value['children']));?>

                        <?php }?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['relationship']->value['id2']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
                        <?php if (isset($_smarty_tpl->tpl_vars['entities']->value['children'])){?>
                            <?php smarty_template_function_getentityname($_smarty_tpl,array('getid'=>$_smarty_tpl->tpl_vars['relationship']->value['id1'],'parents'=>$_smarty_tpl->tpl_vars['entities']->value,'children'=>$_smarty_tpl->tpl_vars['entities']->value['children']));?>
