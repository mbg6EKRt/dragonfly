<?php /* Smarty version Smarty 3.1.4, created on 2014-04-19 17:23:49
         compiled from "614e82e802a2efdf2a0ae857a5859935c5e7f1b8" */ ?>
<?php /*%%SmartyHeaderCode:601605419535295055a33f1-15463374%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '614e82e802a2efdf2a0ae857a5859935c5e7f1b8' => 
    array (
      0 => '614e82e802a2efdf2a0ae857a5859935c5e7f1b8',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '601605419535295055a33f1-15463374',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_535295057b195',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_535295057b195')) {function content_535295057b195($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['first'] = new Smarty_variable('yes', null, 0);?>
...
?>
			<?php if ($_smarty_tpl->tpl_vars['relationship']->value['id1']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
				<p><u><?php echo $_smarty_tpl->tpl_vars['entities']->value['children']['entity'][$_smarty_tpl->tpl_vars['relationship']->value['id2']]['name'];?>
			...
			<?php if ($_smarty_tpl->tpl_vars['relationship']->value['id2']==$_smarty_tpl->tpl_vars['entity']->value['id']){?>
				<p><u><?php echo $_smarty_tpl->tpl_vars['entities']->value['children']['entity'][$_smarty_tpl->tpl_vars['relationship']->value['id1']]['name'];?>
</u><br /><strong><?php echo $_smarty_tpl->tpl_vars['relationship']->value['name'];?>
</strong> <?php echo $_smarty_tpl->tpl_vars['relationship']->value['description'];?>
</p>
			<?php }?>
...
<style>
	...
	.relationship{ width:100%;text-align:center;top:0;left:0; }
</style>
