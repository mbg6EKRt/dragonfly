<?php /* Smarty version Smarty 3.1.4, created on 2014-05-24 18:54:19
         compiled from "6e5c4a164aa98e7c0bac56536bf642e97cf4c27e" */ ?>
<?php /*%%SmartyHeaderCode:15744252865380cebb52ef40-73890594%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e5c4a164aa98e7c0bac56536bf642e97cf4c27e' => 
    array (
      0 => '6e5c4a164aa98e7c0bac56536bf642e97cf4c27e',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '15744252865380cebb52ef40-73890594',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5380cebb758e1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5380cebb758e1')) {function content_5380cebb758e1($_smarty_tpl) {?><h1><?php echo $_smarty_tpl->tpl_vars['formTitle']->value;?>
</h1>
<!--
...
</div><input type="hidden" name="relationships[]" value="<?php if (!isset($_smarty_tpl->tpl_vars['relationship']) || !is_array($_smarty_tpl->tpl_vars['relationship']->value)) $_smarty_tpl->createLocalArrayVariable('relationship');
if ($_smarty_tpl->tpl_vars['relationship']->value['id1'] = $_smarty_tpl->tpl_vars['entity']->value['id']){?><?php echo $_smarty_tpl->tpl_vars['relationship']->value['id2'];?>
<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['relationship']) || !is_array($_smarty_tpl->tpl_vars['relationship']->value)) $_smarty_tpl->createLocalArrayVariable('relationship');
if ($_smarty_tpl->tpl_vars['relationship']->value['id2'] = $_smarty_tpl->tpl_vars['entity']->value['id']){?><?php echo $_smarty_tpl->tpl_vars['relationship']->value['id1'];?>
<?php }?>" />&nbsp;
				<?php } ?>
			</div>
		</div>
